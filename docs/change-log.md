...
- Проверки и оставшиеся ограничения: 12 профильных тестов реестра источников,
  ESLint изменённого TSX-файла и `diff --check` прошли.
- Коммит реализации: ожидается.
- Выкладка: не выполнялась.
- Восстановление: возврат компонента-переключателя восстановит два режима.
...
- Приложение на общем сервере: `702ce2683620d217e0e7513c5a95bee51e03826d`.
