...
- Статус: **В работе**. Владелец: задача Артёма / Codex; ветка `integration/roman-content-center-20260923`.
...
- Проверки: целевые регрессии, сборки обеих частей, история Git, миграции и пересекающиеся контракты. Фактические результаты будут записаны после выполнения.
