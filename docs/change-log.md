...
- Проверки и оставшиеся ограничения: два профильных теста, адресный ESLint и
  TypeScript прошли. Встроенный браузер показывает только форму входа, поэтому
  авторизованный вид страницы пока нельзя визуально проверить.
- Коммит реализации: ожидается.
- Выкладка: не было.
- Восстановление: кодовая правка без изменений БД.
