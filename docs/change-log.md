...
- Проверки и оставшиеся ограничения: 17 профильных тестов, адресный ESLint и
  TypeScript прошли; авторизованный Browser smoke зависит от сессии входа.
- Коммит реализации: ожидается.
- Выкладка: не было.
- Восстановление: откат web-версии; БД не менялась.
