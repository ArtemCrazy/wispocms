...
- Проверки и оставшиеся ограничения: 16 тестов материалов и новый тест раскладки,
  адресный ESLint и TypeScript прошли. Существующий тест nginx-политики
  микрофона падает из-за двух вхождений вместо одного; конфиг не менялся.
  Встроенный браузер дошёл до формы входа, авторизованная страница недоступна.
- Коммит реализации: ожидается.
- Выкладка: не было.
- Восстановление: откат коммита; данные не затронуты.
