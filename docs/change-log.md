...
- Проверки и оставшиеся ограничения: новая точечная регрессия пустого списка,
  ...
  к этой правке интерфейса не относится.
- Коммит реализации: ожидается.
- Выкладка: не выполнялась.
- Восстановление: возврат ручного переключателя не требует изменения данных.
...
- Приложение на общем сервере: `b96cf047d6eebff08930ee45de63753079204cc0`.
