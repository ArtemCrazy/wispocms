...
- Проверки и оставшиеся ограничения: 8/8 точечных тестов обновления источников,
  ESLint изменённого TSX-файла и `git diff --check` пройдены.
- Коммит реализации: ожидается.
- Выкладка: не выполнялась.
- Восстановление: возврат подсказки не требует изменения данных.
...
- Приложение на общем сервере: `062f94526b0965943e02c3d05ebd4086ff4606a5`.
