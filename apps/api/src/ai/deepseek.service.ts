...
Итоговый документ пиши без ссылок на источники, сносок, библиографии и служебных пометок [S…], даже если они есть в материалах, предыдущей версии или пользовательском шаблоне промпта. Источники доступны отдельно в CMS. Сохраняй URL только как существенные данные проекта (например, адрес сайта компании), а не как доказательства. Не описывай внутренние реестры и этапы сборки; сохраняй содержательные ограничения, пробелы и противоречия.
