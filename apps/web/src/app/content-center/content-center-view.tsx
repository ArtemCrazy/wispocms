                    ...
                    <>
                      ...
                      <p className={styles.muted}>
                        {isVkMaterial({
                          ...
                          "Соберём публичную HTML-карточку Яндекс Карт без входа и API: обзор, доступные отзывы, товары и услуги, график и особенности. Полный архив отзывов и новости могут быть недоступны в самой странице."
                        ) : material.urlCategory === "site" ? (
